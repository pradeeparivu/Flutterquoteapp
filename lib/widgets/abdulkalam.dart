...
class Abdulkalam extends StatefulWidget {
  @override
  _AbdulkalamState createState() => _AbdulkalamState();
}

class _AbdulkalamState extends State<Abdulkalam> {
  List<Quote> quotes = [
    Quote(
        text:

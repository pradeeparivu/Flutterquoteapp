...
class AlbertEinstein extends StatefulWidget {
  @override
  _AlbertEinsteinState createState() => _AlbertEinsteinState();
}

class _AlbertEinsteinState extends State<AlbertEinstein> {
  List<Quote> quotes = [
    Quote(
        text:
